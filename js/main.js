...
!function() {
    var a = "undefined" != typeof window && void 0 !== window.document ? window.document : {}
      ...
      , b = function() {
        for (var b, d = ["requestFullscreen exitFullscreen fullscreenElement fullscreenEnabled fullscreenchange fullscreenerror".split(" "), "webkitRequestFullscreen webkitExitFullscreen webkitFullscreenElement webkitFullscreenEnabled webkitfullscreenchange webkitfullscreenerror".split(" "), "webkitRequestFullScreen webkitCancelFullScreen webkitCurrentFullScreenElement webkitCancelFullScreen webkitfullscreenchange webkitfullscreenerror".split(" "), "mozRequestFullScreen mozCancelFullScreen mozFullScreenElement mozFullScreenEnabled mozfullscreenchange mozfullscreenerror".split(" "), "msRequestFullscreen msExitFullscreen msFullscreenElement msFullscreenEnabled MSFullscreenChange MSFullscreenError".split(" ")], g = 0, f = d.length, c = {}; g < f; g++)
            if ((b = d[g]) && b[1]in a) {
...
(function() {
    ...
    function m(a, b) {
        ...
        return !/^(?:boolean|number|string|undefined)$/.test(d) && ("object" == d ? !!a[b] : !0)
    }
    function d(a) {
    ...
    function f(a) {
        function c(c) {
            return g(c, function(g, c) {
                var f = c.pattern || d(c);
                !g && (g = RegExp("\\b" + f + " *\\d+[.\\w_]*", "i").exec(a) || RegExp("\\b" + f + " *\\w+-[\\w]*", "i").exec(a) || RegExp("\\b" + f + "(?:; *(?:[a-z]+[_-])?[a-z]+\\d+|[^ ();-]*)", "i").exec(a)) && ((g = String(c.label && !RegExp(f, "i").test(c.label) ? c.label : g).split("/"))[1] && !/[\d.]+/.test(g[0]) && (g[0] += " " + g[1]),
                c = c.label || c,
                g = b(g[0].replace(RegExp(f, "i"), c).replace(RegExp("; *(?:" + c + "[_-])?", "i"), " ").replace(RegExp("(" + c + ")[-_.]?(\\w)", "i"), "$1 $2")));
                return g
            })
        }
        function q(b) {
        ...
        var u = k.navigator || {}
          , r = u.userAgent || "";
        a || (a = r);
        var v = l ? !!u.likeChrome : /\bChrome\b/.test(a) && !/internal|\n/i.test(z.toString())
        ...
        var Q = L ? "a" : "\u03b1", X = L ? "b" : "\u03b2", U = k.document || {}, M = k.operamini || k.opera, R = t.test(R = l && M ? M["[[Class]]"] : h(M)) ? R : M = null, n, S = a;
        l = [];
        var T = null
          , N = a == r;
        ...
        var D = function(b) {
            return g(b, function(b, g) {
                return b || RegExp("\\b" + (g.pattern || d(g)) + "\\b", "i").exec(a) && (g.label || g)
            })
        }([{
            label: "EdgeHTML",
            pattern: "Edge"
          ...
          , K = function(b) {
            return g(b, function(b, g, c) {
                return b || (g[E] || g[/^[a-z]+(?: +[a-z]+\b)*/i.exec(E)] || RegExp("\\b" + d(c) + "(?:\\b|\\w*\\d)", "i").exec(a)) && c
            })
        }({
            Apple: {
                iPad: 1,
          ...
          , x = function(c) {
            return g(c, function(g, c) {
                var f = c.pattern || d(c);
                if (!g && (g = RegExp("\\b" + f + "(?:/[\\d.]+|[ \\w.]*)", "i").exec(a))) {
                    var e = g
                      , k = c.label || c
                      , l = {
                        "10.0": "10",
                    ...
                    f && k && /^Win/i.test(e) && !/^Windows Phone /i.test(e) && (l = l[/[\d.]+$/.exec(e)]) && (e = "Windows " + l);
                    e = String(e);
                    f && k && (e = e.replace(RegExp(f, "i"), k));
                    g = e = b(e.replace(/ ce$/i, " CE").replace(/\bhpw/i, "web").replace(/\bMacintosh\b/, "Mac OS").replace(/_PowerPC\b/i, " OS").replace(/\b(OS X) [^ \d]+/i, "$1").replace(/\bMac (OS X)\b/, "$1").replace(/\/(\d)/, " $1").replace(/_/g, ".").replace(/(?: BePC|[ .]*fc[ \d.]+)$/i, "").replace(/\bx86\.64\b/gi, "x86_64").replace(/\b(Windows Phone) OS\b/, "$1").replace(/\b(Chrome OS \w+) [\d.]+\b/, "$1").split(" on ")[0])
                }
                return g
            })
        ...
        D && (D = [D]);
        K && !E && (E = c([K]));
        if (n = /\bGoogle TV\b/.exec(E))
            E = n[0];
        /\bSimulator\b/i.test(a) && (E = (E ? E + " " : "") + "Simulator");
        "Opera Mini" == w && /\bOPiOS\b/.test(a) && l.push("running in Turbo/Uncompressed mode");
        "IE" == w && /\blike iPhone OS\b/.test(a) ? (n = f(a.replace(/like iPhone OS/, "")),
        K = n.manufacturer,
        E = n.product) : /^iP/.test(E) ? (w || (w = "Safari"),
        x = "iOS" + ((n = / OS ([\d_]+)/i.exec(a)) ? " " + n[1].replace(/_/g, ".") : "")) : "Konqueror" != w || /buntu/i.test(x) ? K && "Google" != K && (/Chrome/.test(w) && !/\bMobile Safari\b/i.test(a) || /\bVita\b/.test(E)) || /\bAndroid\b/.test(x) && /^Chrome/.test(w) && /\bVersion\//i.test(a) ? (w = "Android Browser",
        x = /\bAndroid\b/.test(x) ? x : "Android") : "Silk" == w ? (/\bMobi/i.test(a) || (x = "Android",
        l.unshift("desktop mode")),
        /Accelerated *= *true/i.test(a) && l.unshift("accelerated")) : "PaleMoon" == w && (n = /\bFirefox\/([\d.]+)\b/.exec(a)) ? l.push("identifying as Firefox " + n[1]) : "Firefox" == w && (n = /\b(Mobile|Tablet|TV)\b/i.exec(a)) ? (x || (x = "Firefox OS"),
        E || (E = n[1])) : !w || (n = !/\bMinefield\b/i.test(a) && /\b(?:Firefox|Safari)\b/.exec(w)) ? (w && !E && /[\/,]|^[^(]+?\)/.test(a.slice(a.indexOf(n + "/") + 8)) && (w = null),
        (n = E || K || x) && (E || K || /\b(?:Android|Symbian OS|Tablet OS|webOS)\b/.test(x)) && (w = /[a-z]+(?: Hat)?/i.exec(/\bAndroid\b/.test(x) ? x : n) + " Browser")) : "Electron" == w && (n = (/\bChrome\/([\d.]+)\b/.exec(a) || 0)[1]) && l.push("Chromium " + n) : x = "Kubuntu";
        r || (r = q(["(?:Cloud9|CriOS|CrMo|Edge|FxiOS|IEMobile|Iron|Opera ?Mini|OPiOS|OPR|Raven|SamsungBrowser|Silk(?!/[\\d.]+$))", "Version", d(w), "(?:Firefox|Minefield|NetFront)"]));
        if (n = "iCab" == D && 3 < parseFloat(r) && "WebKit" || /\bOpera\b/.test(w) && (/\bOPR\b/.test(a) ? "Blink" : "Presto") || /\b(?:Midori|Nook|Safari)\b/i.test(a) && !/^(?:Trident|EdgeHTML)$/.test(D) && "WebKit" || !D && /\bMSIE\b/i.test(a) && ("Mac OS" == x ? "Tasman" : "Trident") || "WebKit" == D && /\bPlayStation\b(?! Vita\b)/i.test(w) && "NetFront")
            D = [n];
        "IE" == w && (n = (/; *(?:XBLWP|ZuneWP)(\d+)/i.exec(a) || 0)[1]) ? (w += " Mobile",
        x = "Windows Phone " + (/\+$/.test(n) ? n : n + ".x"),
        l.unshift("desktop mode")) : /\bWPDesktop\b/i.test(a) ? (w = "IE Mobile",
        x = "Windows Phone 8.x",
        l.unshift("desktop mode"),
        r || (r = (/\brv:([\d.]+)/.exec(a) || 0)[1])) : "IE" != w && "Trident" == D && (n = /\brv:([\d.]+)/.exec(a)) && (w && l.push("identifying as " + w + (r ? " " + r : "")),
        w = "IE",
        r = n[1]);
        if (N) {
            if (m(k, "global"))
                if (L && (n = L.lang.System,
                S = n.getProperty("os.arch"),
                x = x || n.getProperty("os.name") + " " + n.getProperty("os.version")),
                O) {
                    try {
                        r = k.require("ringo/engine").version.join("."),
                        w = "RingoJS"
                    } catch (W) {
                        (n = k.system) && n.global.system == k.system && (w = "Narwhal",
                        x || (x = n[0].os || null))
                    }
                    w || (w = "Rhino")
                } else
                    "object" == typeof k.process && !k.process.browser && (n = k.process) && ("object" == typeof n.versions && ("string" == typeof n.versions.electron ? (l.push("Node " + n.versions.node),
                    w = "Electron",
                    r = n.versions.electron) : "string" == typeof n.versions.nw && (l.push("Chromium " + r, "Node " + n.versions.node),
                    w = "NW.js",
                    r = n.versions.nw)),
                    w || (w = "Node.js",
                    S = n.arch,
                ...
                h(n = k.runtime) == y ? (w = "Adobe AIR",
                x = n.flash.system.Capabilities.os) : h(n = k.phantom) == P ? (w = "PhantomJS",
                r = (n = n.version || null) && n.major + "." + n.minor + "." + n.patch) : "number" == typeof U.documentMode && (n = /\bTrident\/(\d+)/i.exec(a)) ? (r = [r, U.documentMode],
                (n = +n[1] + 4) != r[1] && (l.push("IE " + r[1] + " mode"),
                D && (D[1] = ""),
                r[1] = n),
                r = "IE" == w ? String(r[1].toFixed(1)) : r[0]) : "number" == typeof U.documentMode && /^(?:Chrome|Firefox)\b/.test(w) && (l.push("masking as " + w + " " + r),
                w = "IE",
                r = "11.0",
                D = ["Trident"],
                x = "Windows");
        ...
        r && (n = /(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(r) || /(?:alpha|beta)(?: ?\d)?/i.exec(a + ";" + (N && u.appMinorVersion)) || /\bMinefield\b/i.test(a) && "a") && (T = /b/i.test(n) ? "beta" : "alpha",
        r = r.replace(RegExp(n + "\\+?$"), "") + ("beta" == T ? X : Q) + (/\d+\+?/.exec(n) || ""));
        ...
        else if (!/^(?:Chrome|IE|Opera)$/.test(w) && (!w || E || /Browser|Mobi/.test(w)) || "Windows CE" != x && !/Mobi/i.test(a))
            if ("IE" == w && N)
                try {
                ...
                (/\bBlackBerry\b/.test(E) || /\bBB10\b/.test(a)) && (n = (RegExp(E.replace(/ +/g, " *") + "/([.\\d]+)", "i").exec(a) || 0)[1] || r) ? (n = [n, /BB10/.test(a)],
                x = (n[1] ? (E = null,
                K = "BlackBerry") : "Device Software") + " " + n[0],
                r = null) : this != e && "Wii" != E && (N && M || /Opera/.test(w) && /\b(?:MSIE|Firefox)\b/i.test(a) || "Firefox" == w && /\bOS X (?:\d+\.){2,}/.test(x) || "IE" == w && (x && !/^Win/.test(x) && 5.5 < r || /\bWindows XP\b/.test(x) && 8 < r || 8 == r && !/\bTrident\b/.test(a))) && !t.test(n = f.call(e, a.replace(t, "") + ";")) && n.name && (n = "ing as " + n.name + ((n = n.version) ? " " + n : ""),
                t.test(w) ? (/\bIE\b/.test(n) && "Mac OS" == x && (x = null),
        ...
        if (n = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(a) || 0)[1]) {
            ...
            if ("Safari" == w && "+" == n[1].slice(-1))
                ...
                T = "alpha",
                r = n[1].slice(0, -1);
            else if (r == n[1] || r == (n[2] = (/\bSafari\/([\d.]+\+?)/i.exec(a) || 0)[1]))
                r = null;
            n[1] = (/\bChrome\/([\d.]+)/i.exec(a) || 0)[1];
            537.36 == n[0] && 537.36 == n[2] && 28 <= parseFloat(n[1]) && "WebKit" == D && (D = ["Blink"]);
            N && (v || n[1]) ? (D && (D[1] = "like Chrome"),
            n = n[1] || (n = n[0],
            530 > n ? 1 : 532 > n ? 2 : 532.05 > n ? 3 : 533 > n ? 4 : 534.03 > n ? 5 : 534.07 > n ? 6 : 534.1 > n ? 7 : 534.13 > n ? 8 : 534.16 > n ? 9 : 534.24 > n ? 10 : 534.3 > n ? 11 : 535.01 > n ? 12 : 535.02 > n ? "13+" : 535.07 > n ? 15 : 535.11 > n ? 16 : 535.19 > n ? 17 : 536.05 > n ? 18 : 536.1 > n ? 19 : 537.01 > n ? 20 : 537.11 > n ? "21+" : 537.13 > n ? 23 : 537.18 > n ? 24 : 537.24 > n ? 25 : 537.36 > n ? 26 : "Blink" != D ? "27" : "28")) : (D && (D[1] = "like Safari"),
            n = (n = n[0],
            400 > n ? 1 : 500 > n ? 2 : 526 > n ? 3 : 533 > n ? 4 : 534 > n ? "4+" : 535 > n ? 5 : 537 > n ? 6 : 538 > n ? 7 : 601 > n ? 8 : "8"));
            D && (D[1] += " " + (n += "number" == typeof n ? ".x" : /[.+]/.test(n) ? "" : "+"));
            "Safari" == w && (!r || 45 < parseInt(r)) && (r = n)
        }
        "Opera" == w && (n = /\bzbov|zvav$/.exec(x)) ? (w += " ",
        l.unshift("desktop mode"),
        "zvav" == n ? (w += "Mini",
        r = null) : w += "Mobile",
        x = x.replace(RegExp(" *" + n + "$"), "")) : "Safari" == w && /\bChrome\b/.exec(D && D[1]) && (l.unshift("desktop mode"),
        w = "Chrome Mobile",
        r = null,
        /\bOS X\b/.test(x) ? (K = "Apple",
        x = "iOS 4.3+") : x = null);
        r && 0 == r.indexOf(n = /[\d.]+$/.exec(x)) && -1 < a.indexOf("/" + n + "-") && (x = String(x.replace(n, "")).replace(/^ +| +$/g, ""));
        D && !/\b(?:Avant|Nook)\b/.test(w) && (/Browser|Lunascape|Maxthon/.test(w) || "Safari" != w && /^iOS/.test(x) && /\bSafari\b/.test(D[1]) || /^(?:Adobe|Arora|Breach|Midori|Opera|Phantom|Rekonq|Rock|Samsung Internet|Sleipnir|Web)/.test(w) && D[1]) && (n = D[D.length - 1]) && l.push(n);
        l.length && (l = ["(" + l.join("; ") + ")"]);
        K && E && 0 > E.indexOf(K) && l.push("on " + K);
        E && l.push((/^on /.test(l[l.length - 1]) ? "" : "on ") + E);
        if (x) {
            var V = (n = / ([\d.+]+)$/.exec(x)) && "/" == x.charAt(x.length - n[0].length - 1);
            x = {
                architecture: 32,
        ...
        (n = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(S)) && !/\bi686\b/i.test(S) ? (x && (x.architecture = 64,
        x.family = x.family.replace(RegExp(" *" + n), "")),
        w && (/\bWOW64\b/i.test(a) || N && /\w(?:86|32)$/.test(u.cpuClass || u.platform) && !/\bWin64; x64\b/i.test(a)) && l.unshift("32-bit")) : x && /^OS X/.test(x.family) && "Chrome" == w && 39 <= parseFloat(r) && (x.architecture = 64);
        a || (a = null);
        k = {};
        k.description = a;
        k.layout = D && D[0];
        ...
        k.name && l.unshift(w);
        x && w && (x != String(x).split(" ")[0] || x != w.split(" ")[0] && !E) && l.push(E ? "(" + x + ")" : "on " + x);
    ...
    var v = u.hasOwnProperty
      , z = u.toString
      , r = f();
    "function" == typeof define && "object" == typeof define.amd && define.amd ? (p.platform = r,
    define(function() {
        return r
    })) : q && l ? e(r, function(a, b) {
        q[b] = a
    }) : p.platform = r
}
).call(this);
...
function getSize(a) {
    ...
    if (void 0 === window["inner" + a])
        ...
        m.innerHTML = "<style>@media(" + c + ":" + e["client" + a] + "px){body#vpw-test-b div#vpw-test-d{" + c + ":7px!important}}</style>";
        h.appendChild(m);
...
function sizeHandler() {
    ...
    if ($("#canvas")) {
        ...
        if (e < a) {
            ...
            b < c && (h = c - b,
            b += h,
            e += CANVAS_HEIGHT / CANVAS_WIDTH * h);
        h = a / 2 - e / 2;
        var m = c / 2 - b / 2
          , d = CANVAS_WIDTH / b;
        if (m * d < -EDGEBOARD_X || h * d < -EDGEBOARD_Y)
            s_iScaleFactor = Math.min(a / (CANVAS_HEIGHT - 2 * EDGEBOARD_Y), c / (CANVAS_WIDTH - 2 * EDGEBOARD_X)),
        ...
        null !== s_oModeSelection && s_oModeSelection.refreshButtonPos(s_iOffsetX, s_iOffsetY);
        ...
        s_oStage.scaleX = s_oStage.scaleY = 2 * Math.min(b / CANVAS_WIDTH, e / CANVAS_HEIGHT)) : s_bMobile || isChrome() ? ($("#canvas").css("width", b + "px"),
        $("#canvas").css("height", e + "px")) : (s_oStage.canvas.width = Math.floor(b),
...
function calculateIntersection(a, c) {
    ...
    d = Math.abs(d - f) - (b + h);
    g = Math.abs(g - l) - (e + m);
    return 0 > d && 0 > g ? (d = Math.min(Math.min(a.width, c.width), -d),
...
var aColumn = [370, 340, 310]
  ...
  , TEXT_HELP_1 = "REACH THE END OF THE BOARD LAUNCHING THE DICE. ROLLING A 6 WILL GIVE THE PLAYER AN EXTRA DICE"
...
function CPreloader() {
    ...
    this.attachSprites = function() {
        ...
        f = new CTextButton(CANVAS_WIDTH_HALF,CANVAS_HEIGHT_HALF + 80,p,TEXT_PRELOADER_CONTINUE,"Arial","#000","bold 50",l);
...
function CMain(a) {
    var c, b = 0, e = 0, h = STATE_LOADING, m, d;
    ...
    this._loadImages = function() {
        s_oSpriteLibrary.init(this._onImagesLoaded, this._onAllImagesLoaded, this);
        for (var a = 0; 6 > a; a++)
            s_oSpriteLibrary.addSprite("player_1_" + a, "./sprites/players1/player_" + a + ".png");
        for (a = 1; 7 > a; a++)
            s_oSpriteLibrary.addSprite("dice_" + a, "./sprites/dice_" + a + ".png");
        for (a = 0; a < LADDERS_SQUARES.length; a++)
            s_oSpriteLibrary.addSprite("ladder_" + LADDERS_SQUARES[a], "./sprites/ladders/ladder_" + +LADDERS_SQUARES[a] + ".png");
        for (a = 0; a < OBSTACLES_SQUARES.length; a++)
            s_oSpriteLibrary.addSprite("snake_" + OBSTACLES_SQUARES[a], "./sprites/snakes/snake_" + +OBSTACLES_SQUARES[a] + ".png"),
            s_oSpriteLibrary.addSprite("chute_" + OBSTACLES_SQUARES[a], "./sprites/chutes/chute_" + +OBSTACLES_SQUARES[a] + ".png");
        for (a = 0; 2 > a; a++)
            s_oSpriteLibrary.addSprite("but_mode" + a, "./sprites/but_mode" + a + ".png"),
...
function CModeSelection(a) {
    ...
    this._init = function() {
        k = a;
        var t = a === MODE_SNAKES ? s_oSpriteLibrary.getSprite("bg_game0") : s_oSpriteLibrary.getSprite("bg_game1");
        m = createBitmap(t);
        ...
        g.y = 135;
        s_oStage.addChild(g);
        (new CTLText(g,-250,40,500,40,40,"center",SECONDARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_SELECT_OPPONENTS,!0,!0,!1,!1)).setOutline(5);
        new CTLText(g,-250,40,500,40,40,"center",PRIMARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_SELECT_OPPONENTS,!0,!0,!1,!1);
        var v = CANVAS_HEIGHT_HALF + 20;
        t = s_oSpriteLibrary.getSprite("vs_man_panel");
        q = new CGfxButton(CANVAS_WIDTH_HALF - 120,v,t,s_oStage);
        q.addEventListenerWithParams(ON_MOUSE_UP, this._onButModeRelease, this, HUMAN_VS_HUMAN);
        t = s_oSpriteLibrary.getSprite("vs_pc_panel");
        u = new CGfxButton(CANVAS_WIDTH_HALF + 120,v,t,s_oStage);
        u.addEventListenerWithParams(ON_MOUSE_UP, this._onButModeRelease, this, HUMAN_VS_CPU);
    ...
    this.refreshButtonPos = function(a, d) {
        p.setPosition(c - a, b);
        !1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile || l.setPosition(e - a, h)
    }
    ;
    this.unload = function() {
        p.unload();
...
function CDiceButton(a, c, b) {
    ...
    this.toggle = function(a) {
        a ? (f.gotoAndPlay("on"),
        q = !1,
        s_bMobile || (f.cursor = "pointer")) : (f.gotoAndPlay("off"),
        q = !0,
        s_bMobile || (f.cursor = "normal"))
    }
    ;
    ...
    this.buttonDown = function() {
        q || (f.scaleX = 0 < d ? .9 : -.9,
        f.scaleY = .9,
        e[ON_MOUSE_DOWN] && e[ON_MOUSE_DOWN].call(h[ON_MOUSE_DOWN], m[ON_MOUSE_DOWN]))
    }
    ;
...
function CToggle(a, c, b, e, h) {
    ...
    this._init = function(a, b, c, e) {
        ...
        m = e;
        f = createSprite(k, "state_" + m, c.width / 2 / 2, c.height / 2, c.width / 2, c.height);
        f.x = a;
        f.y = b;
        f.stop();
...
function CGfxButton(a, c, b, e) {
    ...
    this.buttonDown = function() {
        u || (d.scaleX = 0 < f ? .9 : -.9,
        d.scaleY = .9,
        h[ON_MOUSE_DOWN] && h[ON_MOUSE_DOWN].call(m[ON_MOUSE_DOWN], g[ON_MOUSE_DOWN]))
    }
    ;
    this.rotation = function(a) {
        d.rotation = a
...
function CTextButton(a, c, b, e, h, m, d, g) {
    ...
    this._init = function(a, b, d, c, g, e, h, m) {
        ...
        p = [];
        g = createBitmap(d);
        k = new createjs.Text(c," " + h + "px " + PRIMARY_FONT,SECONDARY_FONT_COLOR);
        k.textAlign = "center";
...
function CSpritesheetButton(a, c, b, e, h) {
    ...
    this.buttonDown = function() {
        u || (g.scaleX = 0 < p ? .9 : -.9,
        g.scaleY = .9,
        m[ON_MOUSE_DOWN] && m[ON_MOUSE_DOWN].call(d[ON_MOUSE_DOWN], l[ON_MOUSE_DOWN]))
    }
    ;
    this.rotation = function(a) {
        g.rotation = a
...
function CMenu() {
    var a, c, b, e, h, m, d, g, f, l, p, q, u, k, t, v = null, z = null;
    this._init = function() {
        ...
        r = window.document;
        y = r.documentElement;
        v = y.requestFullscreen || y.mozRequestFullScreen || y.webkitRequestFullScreen || y.msRequestFullscreen;
        z = r.exitFullscreen || r.mozCancelFullScreen || r.webkitExitFullscreen || r.msExitFullscreen;
        !1 === ENABLE_FULLSCREEN && (v = !1);
        v && screenfull.isEnabled && (r = s_oSpriteLibrary.getSprite("but_fullscreen"),
        a = b + r.width / 2 + 10,
        c = e,
        ...
        s_bStorageAvailable ? (r = getItem("snakesandladders_gameswon"),
        null !== r && (s_aGamesWon = r),
        r = getItem("snakesandladders_gamesplayed"),
        null !== r && (s_aGamesPlayed = r)) : new CMsgBox(TEXT_ERR_LS,s_oStage);
        this.refreshButtonPos(s_iOffsetX, s_iOffsetY)
    }
    ;
    this.refreshButtonPos = function(f, l) {
        p.setPosition(h, m - l);
        q.setPosition(b + f, e);
        !1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile || k.setPosition(d - f, g);
...
function CGame(a, c, b, e) {
    var h, m, d, g, f, l, p, q, u, k, t, v, z, r, y, B, F, A, C, G, I, H, J, O, L, P, Q;
    this._init = function(a, b, c, e) {
        v = c;
        f = a;
        l = b;
        ...
        if (v === HUMAN_VS_CPU)
            ...
            e = [],
            b = 0; b < f; b++)
                d.push(new CPlayers(b,G,I,a[b])),
                e.push(a[b]);
        else
            for (b = 0; b < f; b++)
                d.push(new CPlayers(b,G,I,e[b]));
        this.arrangePlayerZ();
        Q = new CDice;
    ...
    this.arrangeSquarePlayers = function(a, b, c) {
        ...
        s_iModeGame === MODE_SNAKES && (new createjs.Tween.get(d[a].getShadow())).to({
            x: this.getBoardSquareX(b) + c,
            y: this.getBoardSquareY(b) + c
        }, 150)
    }
    ...
    this.checkForAnotherPlayer = function(a, b) {
        ...
        1 < c ? (s_oGame.arrangeSquarePlayers(b, a, c),
        s_oGame.arrangePlayerZ()) : s_oBoard.setSquareOccupied(a, !1)
    }
    ;
    this.checkForSpecialSquares = function(a) {
        ...
        if (b === LAST_SQUARE)
            s_oGame.onWin(a);
        !0 === ifArrayContainsValue(OBSTACLES_SQUARES, b) ? (playSound("malus", 1, !1),
        new CMotivationalMsg(MSG_BAD),
        h = this.obstacleSquare,
        m = a) : !0 === ifArrayContainsValue(LADDERS_SQUARES, b) ? (playSound("bonus", 1, !1),
        new CMotivationalMsg(MSG_GOOD),
        h = this.ladderSquare,
        m = a) : (h = this.changeTurn,
        m = !0)
    }
    ;
    ...
    this.ladderSquare = function(a) {
        ...
        for (var e = 0; e < LADDER_MOVEMENT_SQUARES.length; e++)
            if (d[a].getPosition() === LADDER_MOVEMENT_SQUARES[e][0]) {
                ...
                s_iModeGame === MODE_SNAKES && (new createjs.Tween.get(c)).to({
                    x: g,
                    y: k
    ...
    this.changeTurn = function() {
        ...
        6 !== u ? (t++,
        t > f - 1 && (t = 0),
        s_oGame.changePlayerTurn()) : (playSound("bonus", 1, !1),
        new CMotivationalMsg(MSG_DICE))
    }
    ;
    ...
    this.checkFinalSquare = function(a, b) {
        ...
        if (!0 === PERFECT_SCORE) {
            if (c === LAST_SQUARE && 0 === b)
                s_oGame.onWin(a);
            c >= LAST_SQUARE ? s_oGame.playerBack(a, b) : s_oGame.playerAdvance(a, b)
        } else if (c === LAST_SQUARE)
            s_oGame.onWin(a);
        else
            s_oGame.playerAdvance(a, b)
    }
    ;
    ...
    this.onWin = function(a) {
        ...
        if (s_iModeGame === MODE_CHUTES)
            for (var b = 0; b < d.length; b++)
                d[b].animationIdle();
        v === HUMAN_VS_CPU ? a === p ? (s_aGamesWon++,
        saveItem("snakesandladders_gameswon", s_aGamesWon),
        s_oGame.gameWin()) : s_oGame.gameOver(a) : (s_aGamesWon++,
        saveItem("snakesandladders_gameswon", s_aGamesWon),
        s_oGame.gameWin())
    }
    ;
    ...
    this.launchDices = function() {
        v === HUMAN_VS_CPU && t !== p || !0 !== s_oInterface.DicesEnabled() || !0 !== s_oGame.isTurnReady() || s_oDices.show()
    }
    ;
    ...
    this.checkForNextTurn = function() {
        v === HUMAN_VS_CPU ? t !== p ? (d[t].setArrowVisible(!1),
        s_oDices.show(),
        H.enableDices(!1),
        H.animationDiceButtonStop()) : (!1 === d[t].isArrowVisible() && (d[t].setArrowVisible(!0),
        this.setArrow(t)),
        H.enableDices(!0),
        !0 === H.DicesEnabled() && H.animationDiceButton()) : (!1 === d[t].isArrowVisible() && (d[t].setArrowVisible(!0),
        this.setArrow(t)),
        H.enableDices(!0),
    ...
    this.checkForFirstTurn = function() {
        if (s_oDices.isFirstLaunch)
            for (var a = 0; a < d.length; a++)
                0 < d[a].getPosition() ? s_oDices.setFirstLaunch(!1) : s_oDices.setFirstLaunch(!0)
    }
    ;
    this.onEndChuteAnimation = function() {
        B = !1;
        for (var a = d[t].getPosition(), b = 0; b < OBSTACLES_MOVEMENT_SQUARES.length; b++)
            a === OBSTACLES_MOVEMENT_SQUARES[b][0] && s_oGame.obstacleAnimationOver(t, b)
    }
    ;
    this.update = function() {
        !0 === z && (!0 === r && this.checkForNextTurn(),
        !0 === y && (k += s_iTimeElaps,
        500 < k && this.endTimeoutSpecialSquare()),
        B && d[t].update())
    }
    ;
    s_oGame = this;
...
function CPlayers(a, c, b, e) {
    ...
    this._init = function() {
        ...
        if (s_iModeGame === MODE_SNAKES) {
            ...
            g = createSprite(k, h, q[s_iModeGame], u[s_iModeGame] - 10, q[s_iModeGame], u[s_iModeGame]);
            g.gotoAndStop(h)
        } else
            k = {
            ...
            k = new createjs.SpriteSheet(k),
            g = createSprite(k, "idle", PLAYER_SPRITE_WIDTH[h], PLAYER_SPRITE_HEIGHT[h], PLAYER_SPRITE_WIDTH[h], PLAYER_SPRITE_HEIGHT[h]);
    ...
    this.reset = function() {
        ...
        g.x = ZERO_SQUARE_POSITIONS[a][0];
        g.y = ZERO_SQUARE_POSITIONS[a][1];
        s_iModeGame === MODE_SNAKES ? (d.x = ZERO_SQUARE_POSITIONS[a][0],
        d.y = ZERO_SQUARE_POSITIONS[a][1]) : (g.gotoAndStop("idle"),
        g.scaleX = 1)
    }
    ;
    this.getX = function() {
...
function CBoard(a, c, b) {
    ...
    this.initObstaclesOnBoard = function() {
        if (s_iModeGame === MODE_SNAKES)
            for (var a = [150, 150, 120, 190, 96, 170, 230, 100, 100, 100], b = [100, 150, 200, 72, 310, 90, 380, 130, 130, 130], d = [650, 780, 930, 730, 525, 525, 680, 855, 665, 495], e = [545, 400, 425, 280, 385, 275, 305, 120, 120, 120], h = 0; h < OBSTACLES_SQUARES.length; h++) {
                var k = {
...
function CInterface(a) {
    var c, b, e, h, m, d, g, f, l, p, q, u, k, t, v = null, z, r, y, B, F, A, C, G, I, H = null, J = null;
    this._init = function() {
        m = CANVAS_WIDTH - 50;
        d = CANVAS_HEIGHT - 50;
        ...
        J = a.exitFullscreen || a.mozCancelFullScreen || a.webkitExitFullscreen || a.msExitFullscreen;
        !1 === ENABLE_FULLSCREEN && (H = !1);
        H && screenfull.isEnabled && (a = s_oSpriteLibrary.getSprite("but_fullscreen"),
        r ? (g = l,
        f = p + a.height + 10) : (g = l,
        f = p),
    ...
    this.onSettings = function() {
        G ? s_oInterface.closePanel() : (z = new CPauseButton(t),
        G = !0,
        F.setX(y.getX()),
        F.setY(y.getY()),
        F.setVisible(!0),
    ...
    this.closePanel = function() {
        ...
        r && (new createjs.Tween.get(r.getButtonImage())).to({
            x: y.getX(),
            y: y.getY()
        }, 300, createjs.Ease.cubicIn);
        A && (new createjs.Tween.get(A.getButtonImage())).to({
            x: y.getX(),
            y: y.getY()
        }, 300, createjs.Ease.cubicIn)
    }
    ...
    this.refreshButtonPos = function(k, t) {
        ...
        !1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile || r.setPosition(l - k, p);
    ...
    ;
    this._onFullscreenRelease = function() {
        s_bFullscreen ? J.call(window.document) : H.call(window.document.documentElement);
        sizeHandler()
    }
    ;
...
function CPlayersInterface(a) {
    ...
    this._init = function() {
        ...
        e.addChild(h);
        for (var d = [34, 44], g = [34, 44], f = "turns" + s_iModeGame, l = 0; l < a.length; l++) {
            var p = {
            ...
            m[l] = createSprite(p, 0, d[s_iModeGame] / 2, g[s_iModeGame] / 2, d[s_iModeGame], g[s_iModeGame]);
            m[l].x = 45;
            m[l].y = 79.5 + 50 * l;
            m[l].gotoAndStop(a[l]);
            m[l].visible = !0;
...
function CHelpPanel() {
    ...
    this._init = function() {
        ...
        k.addChild(q, u);
        s_oStage.addChild(k);
        b = new CTLText(k,CANVAS_WIDTH_HALF - 250,CANVAS_HEIGHT_HALF - 160,500,70,22,"center",SECONDARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_HELP_1,!0,!0,!0,!1);
        b.setOutline(4);
        new CTLText(k,CANVAS_WIDTH_HALF - 250,CANVAS_HEIGHT_HALF - 160,500,70,22,"center",PRIMARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_HELP_1,!0,!0,!0,!1);
        e = new CTLText(k,CANVAS_WIDTH_HALF - 110,CANVAS_HEIGHT_HALF - 30,320,40,22,"left",SECONDARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_HELP2_PT1,!0,!0,!0,!1);
        e.setOutline(4);
        new CTLText(k,CANVAS_WIDTH_HALF - 110,CANVAS_HEIGHT_HALF - 30,320,40,22,"left",PRIMARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_HELP2_PT1,!0,!0,!0,!1);
        h = new CTLText(k,CANVAS_WIDTH_HALF - 200,CANVAS_HEIGHT_HALF + 64,320,40,22,"right",SECONDARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_HELP2_PT1,!0,!0,!1,!1);
        h.setOutline(4);
        m = new CTLText(k,CANVAS_WIDTH_HALF - 200,CANVAS_HEIGHT_HALF + 64,320,40,22,"right",PRIMARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_HELP2_PT1,!0,!0,!1,!1);
        s_iModeGame === MODE_SNAKES ? (h.refreshText(TEXT_MODE0 + TEXT_HELP2_PT2),
        m.refreshText(TEXT_MODE0 + TEXT_HELP2_PT2)) : (h.refreshText(TEXT_MODE1 + TEXT_HELP2_PT2),
        ...
        k.addChild(p);
        s_iModeGame === MODE_SNAKES ? (f = createBitmap(z),
        f.regX = .5 * z.width,
        f.regY = .5 * z.height,
        f.x = p.x - 20,
        f.y = p.y - 45,
        ...
        (new createjs.Tween.get(f,{
            ...
            x: p.x + 30,
            y: p.y + 10
        }, 300, createjs.Ease.linear).wait(500)) : (l = createBitmap(z),
        l.regX = .5 * z.width,
        l.regY = .5 * z.height,
        l.x = p.x - 25,
        l.y = p.y - 35,
...
function CEndPanel(a) {
    ...
    this._init = function(a) {
        ...
        h.regY = .5 * a.height;
        q.addChild(h);
        m = new CTLText(q,CANVAS_WIDTH_HALF - 250,160,500,40,40,"center",SECONDARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_WIN,!0,!0,!1,!1);
        m.setOutline(5);
        d = new CTLText(q,CANVAS_WIDTH_HALF - 250,160,500,40,40,"center",PRIMARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_WIN,!0,!0,!1,!1);
        g = new CTLText(q,CANVAS_WIDTH_HALF - 250,220,500,40,20,"center",SECONDARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_GAMES_PLAYED + ": " + s_aGamesPlayed,!0,!0,!1,!1);
        g.setOutline(5);
        f = new CTLText(q,CANVAS_WIDTH_HALF - 250,220,500,40,20,"center",PRIMARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_GAMES_PLAYED + ": " + s_aGamesPlayed,!0,!0,!1,!1);
        l = new CTLText(q,CANVAS_WIDTH_HALF - 250,265,500,40,20,"center",SECONDARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_GAMES_WON + ": " + s_aGamesWon,!0,!0,!1,!1);
        l.setOutline(5);
        p = new CTLText(q,CANVAS_WIDTH_HALF - 250,265,500,40,20,"center",PRIMARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_GAMES_WON + ": " + s_aGamesWon,!0,!0,!1,!1);
        s_oStage.addChild(q);
    ...
    this.show = function(a) {
        q.visible = !0;
        v.visible = !0;
        a ? (m.refreshText(TEXT_WIN),
        d.refreshText(TEXT_WIN)) : (m.refreshText(TEXT_LOSE),
        d.refreshText(TEXT_LOSE));
        ...
        createjs.Tween.get(q).wait(250).to({
            y: 0
...
function CMotivationalMsg(a) {
    ...
    this._init = function() {
        ...
        m = CANVAS_WIDTH + 300,
        d = CANVAS_HEIGHT_HALF) : (b.x = CANVAS_WIDTH_HALF,
        b.y = -100,
        m = CANVAS_WIDTH_HALF,
        d = CANVAS_HEIGHT + 300);
        s_oStage.addChild(b);
        c = new CTLText(b,-350,40,700,40,60,"center",THIRD_FONT_COLOR,PRIMARY_FONT,1,0,0,e,!0,!0,!1,!1);
        c.setOutline(3);
        new CTLText(b,-350,40,700,40,60,"center",PRIMARY_FONT_COLOR,PRIMARY_FONT,1,0,0,e,!0,!0,!1,!1);
        (new createjs.Tween.get(b)).to({
            x: CANVAS_WIDTH_HALF,
            y: CANVAS_HEIGHT_HALF
        }, h, createjs.Ease.cubicIn).call(this.exit)
    }
    ;
    this.exit = function() {
        (new createjs.Tween.get(b)).wait(h).to({
            x: m,
            y: d
        }, .5 * h, createjs.Ease.cubicOut).call(function() {
...
function CMsgBox(a, c) {
    ...
    this._init = function(a) {
        ...
        c.regY = .5 * a.height;
        e.addChild(c);
        new CTLText(e,CANVAS_WIDTH_HALF - 250,CANVAS_HEIGHT_HALF - 140,500,160,20,"center",PRIMARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_ERR_LS,!0,!0,!0,!1);
        b = new CGfxButton(CANVAS_WIDTH_HALF,CANVAS_HEIGHT_HALF + 100,s_oSpriteLibrary.getSprite("but_yes"),e);
...
function CPlayersChoose(a) {
    ...
    this._init = function() {
        ...
        l.y = 135;
        s_oStage.addChild(l);
        (new CTLText(l,-250,30,500,40,40,"center",SECONDARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_SELECT_PLAYERS,!0,!0,!1,!1)).setOutline(5);
        new CTLText(l,-250,30,500,40,40,"center",PRIMARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_SELECT_PLAYERS,!0,!0,!1,!1);
        if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile)
    ...
    this.refreshButtonPos = function(a, b) {
        u.setPosition(e - a, h);
        !1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile || q.setPosition(m - a, d)
    }
    ;
    this.unload = function() {
        u.unload();
...
function CModeChoose() {
    ...
    this._init = function() {
        ...
        f.y = 135;
        s_oStage.addChild(f);
        (new CTLText(f,-250,40,500,40,40,"center",SECONDARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_SELECT_MODE,!0,!0,!1,!1)).setOutline(5);
        new CTLText(f,-250,40,500,40,40,"center",PRIMARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_SELECT_MODE,!0,!0,!1,!1);
        if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile)
            t = s_oSpriteLibrary.getSprite("audio_icon"),
        ...
        u.addEventListener(ON_MOUSE_UP, function() {
    ...
    this.refreshButtonPos = function(a, c) {
        q.setPosition(b - a, e);
        !1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile || p.setPosition(h - a, m)
    }
    ;
    this.unload = function() {
        q.unload();
...
function CColourChoose(a, c) {
    var b, e, h, m, d, g, f, l, p, q, u, k, t, v, z, r, y = 1, B;
    this._init = function() {
        t = new createjs.Container;
        s_oStage.addChild(t);
        d = c;
        ...
        t.addChild(f);
        l = new createjs.Container;
        z = new CTLText(l,-250,40,500,40,40,"center",SECONDARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_SELECT_COLOUR,!0,!0,!1,!1);
        z.setOutline(5);
        r = new CTLText(l,-250,40,500,40,40,"center",PRIMARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_SELECT_COLOUR,!0,!0,!1,!1);
        d === HUMAN_VS_HUMAN && (B = [],
        ...
        k = [];
        k[0] = new CSpritesheetButton(A[s_iModeGame] / 2,C[s_iModeGame] / 2,I,0,v);
        k[0].setShape(1);
        k[0].addEventListener(ON_MOUSE_UP, function() {
            this._onButColourRelease(0)
        }, this);
        k[1] = new CSpritesheetButton(A[s_iModeGame] / 2,C[s_iModeGame] / 2,I,1,v);
        k[1].setShape(1);
        k[1].addEventListener(ON_MOUSE_UP, function() {
            this._onButColourRelease(1)
        }, this);
        k[2] = new CSpritesheetButton(A[s_iModeGame] / 2,C[s_iModeGame] / 2,I,2,v);
        k[2].setShape(1);
        k[2].addEventListener(ON_MOUSE_UP, function() {
            this._onButColourRelease(2)
        }, this);
        k[3] = new CSpritesheetButton(A[s_iModeGame] / 2,C[s_iModeGame] / 2,I,3,v);
        k[3].setShape(1);
        k[3].addEventListener(ON_MOUSE_UP, function() {
            this._onButColourRelease(3)
        }, this);
        k[4] = new CSpritesheetButton(A[s_iModeGame] / 2,C[s_iModeGame] / 2,I,4,v);
        k[4].setShape(1);
        k[4].addEventListener(ON_MOUSE_UP, function() {
            this._onButColourRelease(4)
        }, this);
        k[5] = new CSpritesheetButton(A[s_iModeGame] / 2,C[s_iModeGame] / 2,I,5,v);
        k[5].setShape(1);
        k[5].addEventListener(ON_MOUSE_UP, function() {
            this._onButColourRelease(5)
        }, this);
        s_iModeGame === MODE_SNAKES ? k[0].setPosition(G[s_iModeGame] + a[s_iModeGame] / 2, C[s_iModeGame] / 1.5) : k[0].setPosition(G[s_iModeGame] + a[s_iModeGame] / 2 + a[s_iModeGame], C[s_iModeGame] / 1.5);
        k[1].setPosition(G[s_iModeGame] + (A[s_iModeGame] / 2 * 2 + a[s_iModeGame]), C[s_iModeGame] / 1.5);
        k[2].setPosition(G[s_iModeGame] + (A[s_iModeGame] / 2 * 3 + 2 * a[s_iModeGame]), C[s_iModeGame] / 1.5);
        k[3].setPosition(G[s_iModeGame] + (A[s_iModeGame] / 2 * 4 + 3 * a[s_iModeGame]), C[s_iModeGame] / 1.5);
        k[4].setPosition(G[s_iModeGame] + (A[s_iModeGame] / 2 * 5 + 4 * a[s_iModeGame]), C[s_iModeGame] / 1.5);
        k[5].setPosition(G[s_iModeGame] + (A[s_iModeGame] / 2 * 6 + 5 * a[s_iModeGame]), C[s_iModeGame] / 1.5);
        a = v.getBounds();
    ...
    this.refreshButtonPos = function(a, c) {
        u.setPosition(b - a, e);
        !1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile || q.setPosition(h - a, m)
    }
    ;
    this.unload = function() {
        u.unload();
    ...
    this._onButColourRelease = function(b) {
        d === HUMAN_VS_CPU ? (this.unload(),
        s_oMain.gotoGame(a, b, d)) : (B[y - 1] = b,
        y++,
        k[b].setVisible(!1),
        r.refreshText(TEXT_PLAYER_COLOUR.format(y)),
        z.refreshText(TEXT_PLAYER_COLOUR.format(y)),
        y > a && (this.unload(),
        s_oMain.gotoGame(a, b, d, B)))
    }
    ;
    this._onFullscreenRelease = function() {
        s_bFullscreen ? null.call(window.document) : null.call(window.document.documentElement);
        sizeHandler()
    }
    ;
    this.resetFullscreenBut = function() {}
...
function CCreditsPanel() {
    ...
    this._init = function() {
        ...
        q.addChild(e);
        g = new createjs.Text(TEXT_CREDITS_DEVELOPED,"40px " + PRIMARY_FONT,SECONDARY_FONT_COLOR);
        g.textAlign = "center";
        ...
        q.addChild(h);
        p = new createjs.Text(TEXT_LINK,"28px " + PRIMARY_FONT,SECONDARY_FONT_COLOR);
        p.textAlign = "center";
...
function CPause() {
    ...
    this._init = function() {
        ...
        (new CGfxButton(.5 * CANVAS_WIDTH,.5 * CANVAS_HEIGHT + 70,b,c)).addEventListenerWithParams(ON_MOUSE_UP, this._onLeavePause, this, c);
        s_oStage.addChild(c);
...
function CAreYouSurePanel() {
    ...
    this._init = function() {
        ...
        (new CTLText(h,CANVAS_WIDTH_HALF - 200,CANVAS_HEIGHT_HALF - 140,400,120,50,"center",SECONDARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_ARE_SURE,!0,!0,!0,!1)).setOutline(5);
        new CTLText(h,CANVAS_WIDTH_HALF - 200,CANVAS_HEIGHT_HALF - 140,400,120,50,"center",PRIMARY_FONT_COLOR,PRIMARY_FONT,1,0,0,TEXT_ARE_SURE,!0,!0,!0,!1);
        d = CANVAS_HEIGHT_HALF + 60;
        c = new CGfxButton(CANVAS_WIDTH_HALF + 100,d,s_oSpriteLibrary.getSprite("but_yes"),h);
        c.addEventListener(ON_MOUSE_UP, this._onButYes, this);
        b = new CGfxButton(CANVAS_WIDTH_HALF - 100,d,s_oSpriteLibrary.getSprite("but_no"),h);
...
function CBezier() {
    ...
    this._length = function(a) {
        ...
        return (2 * Math.sqrt(f) * (2 * f * a * b + l * (b - Math.sqrt(p))) + (l * l - 4 * f * p) * (Math.log(l + 2 * Math.sqrt(f) * Math.sqrt(p)) - Math.log(l + 2 * f * a + 2 * Math.sqrt(f) * b))) / (8 * Math.pow(f, 1.5))
    }
    ;
    ...
    this.getAnchorPoint = function(d) {
        if (0 <= d && d <= e) {
            ...
            var g = (1 - f) * (1 - f) * a.y + 2 * (1 - f) * f * c.y + f * f * b.y
              , h = new createjs.Point((1 - f) * a.x + f * c.x,(1 - f) * a.y + f * c.y);
